...
import { tripleSale } from '../../api/authenticationService';
...
class ComponentToPrintThree extends React.Component{
...
//     }
 ...
 handleSubmit = e =>{
    ...
    render(){
        const {pNameOne, pNameTwo, pNameThree, quantityOne, quantityTwo, quantityThree, 
                regPriceOne, regPriceTwo, regPriceThree, discountOne, discountTwo, discountThree, 
                priceOne, priceTwo, priceThree, totalPrice} = this.state
                ...
                <div>
                  ...
                  <form onSubmit={this.handleSubmit} >
                    ...
                    <input type="number" style={{display: 'margin-right:10px', maxWidth:'3.7em', border:'none', borderColor:'white'}}
                      ...
                      placeholder='Amount'
                      name="totalPrice"
                      value= {afterDiscountPriceOne + afterDiscountPriceTwo + afterDiscountPriceThree}
                      onChange={this.handleChange}
...
export default ComponentToPrintThree;
